package dev.gaphunter.jdbcdoubleclosecompanion.review
...
object ReviewPrompt {
    ...
    private const val KEY_SEEN_FINDINGS = "dev.gaphunter.jdbcdoubleclosecompanion.review.seenFindings"
    private const val KEY_ANSWERED = "dev.gaphunter.jdbcdoubleclosecompanion.review.answered"

    private const val NOTIFICATION_GROUP_ID = "JDBC Double-Close Companion"

    // Marketplace listing (real ID resolved after first publish).
    private const val MARKETPLACE_URL = "https://plugins.jetbrains.com/plugin/34070-jdbc-double-close-companion/reviews"
